...
namespace PortableStorage.UI
{
	public class BuilderReservePanel : BaseBagPanel<BuilderReserve>
	{
		...
		private class UIBuilderReserveSlot : BaseElement
		{
			...
			public UIBuilderReserveSlot(BuilderReserve builderReserve, int slot)
			{
				Width.Pixels = 44;
				Height.Pixels = 44;
				...
				storage = builderReserve.GetItemStorage();
			}
			...
			public override int CompareTo(BaseElement other) => other is UIBuilderReserveSlot uiSlot ? slot.CompareTo(uiSlot.slot) : 0;

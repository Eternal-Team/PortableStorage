...
//using DelegateMethods = Terraria.DelegateMethods;
...
//	{
//		public static void Player_DropSelectedItem(Player.orig_DropSelectedItem orig, Terraria.Player self)
//		{
...
//		public static bool Player_BuyItem(Player.orig_BuyItem orig, Terraria.Player self, int price, int customCurrency)
//		{
...
//		//public static bool Player_CanBuyItem(Player.orig_CanBuyItem orig, Terraria.Player self, int price, int customCurrency)
//		//{
//		//	if (customCurrency != -1) return CustomCurrencyManager.BuyItem(self, price, customCurrency);
...
//		public static bool Player_HasAmmo(Player.orig_HasAmmo orig, Terraria.Player self, Item ammoUser, bool canUse)
//		{
...
//		public static void Player_PickAmmo(Player.orig_PickAmmo orig, Terraria.Player self, Item sItem, ref int shoot, ref float speed, ref bool canShoot, ref int Damage, ref float KnockBack, bool dontConsume)
//		{
//			Item item = new Item();
...
//		public static Item Player_QuickHeal_GetItemToUse(Player.orig_QuickHeal_GetItemToUse orig, Terraria.Player self)
//		{
...
//		public static void Player_QuickMana(Player.orig_QuickMana orig, Terraria.Player self)
//		{
...
//		public static void Player_QuickBuff(Player.orig_QuickBuff orig, Terraria.Player self)
//		{
